    ...
    <div id="mescroll" class="mescroll">
        <div class="mescroll-bounce">
            <div id="dataList"  class="data-list music-list v-transition">
                <div class="music-list-item" v-for="readingItem in readingList" :key="readingItem.id" @click="goDetail(readingItem.item_id)">
                    <div class="music-list-tag">- <span>音乐</span> -</div>
                    <div class="music-list-item-title">
                        <p>{{ readingItem.title }}</p>
                        <p class="music-list-item-title__desc">{{ readingItem.share_list.wx ? $_utils.getAuthor(readingItem.share_list.wx.desc) : ''}}</p>
                    </div>
                    <div class="music-list-item-cover">
                        <div class="music-list-item-cover-background"></div>
                        <div class="music-list-item-cover-img">
                            <img :src="readingItem.img_url" alt="" class="music-list-item-img">
                        </div>
                    ...
                    <div class="music-list-item-content">
                        <p class="music-list-item-music__desc">{{ readingItem.author.user_name }} | {{ readingItem.subtitle }}</p>
                        <p class="music-list-item-content-title">{{ readingItem.forward }}</p>
                        <p class="music-list-item-content-date">{{ $_utils.formatDate(readingItem.post_date) }}</p>
                    </div>
                </div>
            </div>
        </div>
