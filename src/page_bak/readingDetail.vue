    ...
    <div id="mescroll" class="mescroll">
        <div class="mescroll-bounce">
            <div class="music-detail-banner">
                ...
                <img class="music-detail-banner-img" :src="readingDetail.cover" alt="">               
                <img src="http://image.wufazhuce.com/music-detail-play.png" alt="" class="music-detail-banner-play-btn">
            </div>
            <div class="music-detail-info">
                <p>{{ readingDetail.title }}</p>
                <p>{{ readingDetail.album }}</p>
                <p>{{ readingDetail.story_author ? readingDetail.story_author.user_name : '' }}</p>
            </div>
            <div class="music-detail-title">
                <p>{{ readingDetail.story_title }}</p>
            </div>
            <div class="music-detail-author">
                <p>文/{{ readingDetail.story_author ? readingDetail.story_author.user_name : '' }}</p>
            </div>
            <div class="music-detail-content" v-html="readingDetail.story ? readingDetail.story : ''">
            </div>
            ...
            <div class="music-detail-author-wrap">
                ...
                <div class="music-detail-author-detail">
                    <img :src="readingDetail.author_list[0] ? readingDetail.author_list[0].web_url : ''" alt="">
                    <div class="music-detail-author-detail-info">
                        <p>{{ readingDetail.author_list[0] ? readingDetail.author_list[0].user_name : '' }}</p>
                        <p class="music-detail-author-detail-desc">{{ readingDetail.author_list[0] ? readingDetail.author_list[0].desc : '' }}</p>
                    </div>
                </div>
            </div>
